...
class ClipperConnection(object):
    ...
    def submit_query(self, url, headers, data):
        """Run the session with the query data 

        Returns
        -------
        Any
            The customized query's result 
        ...
        return self.model_func(json.loads(data)['input'])
